"""
Django settings for levelupback project.
...
WSGI_APPLICATION = 'levelupback.wsgi.application'
...
if not DEBUG:
    ...
    CSRF_TRUSTED_ORIGINS = env_list('CSRF_TRUSTED_ORIGINS', 'https://levelupconsultancy-two.vercel.app/')
